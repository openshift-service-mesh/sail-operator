...
type IstioCNISpec struct {
	...
	// Must be one of: ambient, default, demo, empty, minimal, openshift-ambient, openshift, preview, remote, stable.
	...
	// +kubebuilder:validation:Enum=ambient;default;demo;empty;minimal;openshift-ambient;openshift;preview;remote;stable
