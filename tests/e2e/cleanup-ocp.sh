...
cleanup_cluster_resources() {
  ...
  ${COMMAND} delete clusterrolebinding servicemeshoperator3-metrics-reader-rolebinding --ignore-not-found

  echo "Removing cluster roles..."
  ${COMMAND} delete clusterrole servicemeshoperator3-metrics-reader --ignore-not-found
}
