...
require (
	...
	istio.io/istio v0.0.0-20260629163924-ff49c1889eba
	k8s.io/api v0.34.3
...
replace istio.io/istio => github.com/openshift-service-mesh/istio v0.0.0-20260720134347-22173b9e4c96
