...
require (
	...
	istio.io/client-go v1.30.0-alpha.1.0.20260423170018-1517d774e4ff
	istio.io/istio v0.0.0-20260426025444-bd309b9694ff
	k8s.io/api v0.35.3
...
require (
	...
	istio.io/api v1.30.0-alpha.1.0.20260423165719-9607dc87975d // indirect
