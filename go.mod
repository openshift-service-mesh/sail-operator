...
require (
	...
	istio.io/api v1.26.7-0.20251203124221-04fd5ef0d3ca // indirect
...
replace istio.io/istio => github.com/openshift-service-mesh/istio v0.0.0-20260202085733-b501c5ca70b5
