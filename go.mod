...
require (
	...
	istio.io/client-go v1.30.5
	istio.io/istio v0.0.0-20260918160134-55b832fad2bc
	k8s.io/api v0.35.3
...
replace istio.io/istio => github.com/openshift-service-mesh/istio v0.0.0-20260831151711-ebe5a1eaadb3
