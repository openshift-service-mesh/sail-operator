# Scoping the service mesh with DiscoverSelectors
This page describes how the service mesh control plane monitors cluster resources and how to manage its scope. 
