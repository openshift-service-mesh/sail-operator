...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `version` _string_ | Defines the version of Istio to install. Must be one of: v1.23.0. | v1.23.0 | Enum: [v1.23.0]   |
...
| `version` _string_ | Defines the version of Istio to install. Must be one of: v1.23.0. |  | Enum: [v1.23.0]   |
